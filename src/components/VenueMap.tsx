...
export function VenueMap({
  ...
  const openPopup = (map: maplibregl.Map, f: GeoFeature) => {
    ...
    const html = `<div style="font-family:var(--font-serif);max-width:260px">
      <div style="font-family:'Fraunces',serif;font-weight:500;font-size:1.05rem;color:#23211E">${String(p.name || "")}</div>
      ${subtitle ? `<div style="font-family:'Fraunces',serif;font-weight:400;font-style:italic;font-size:0.85rem;margin-top:2px;color:#6B4A1F">${subtitle}</div>` : ""}
