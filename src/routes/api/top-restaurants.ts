...
RANKING PRIORITY — RESTAURANTS (apply in this strict order, fill the 10 slots top-down):
  1. Venues on the MOST CURRENT World's 50 Best Restaurants list (top 50 first, then extended 51–100), ordered by their rank (lower rank = higher priority).
...
RANKING PRIORITY — COCKTAIL BARS (apply in this strict order, fill the 10 slots top-down):
  1. Venues on the MOST CURRENT World's 50 Best Bars list (top 50 first, then extended 51–100), ordered by rank.
  2. Then venues that have won a Tales of the Cocktail Spirited Award (most prestigious / most recent first).
