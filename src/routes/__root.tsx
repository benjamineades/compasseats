...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Type any city. CompassEats points you to its best restaurants and cocktail bars — ranked by the guides that matter: Michelin, World's 50 Best, and more." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://compasseats.com" },
      { property: "og:image", content: "https://compasseats.com/og-image.jpg" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "CompassEats — the world's best restaurants & bars, wherever you are" },
      { name: "twitter:description", content: "Type any city. CompassEats points you to its best restaurants and cocktail bars — ranked by the guides that matter: Michelin, World's 50 Best, and more." },
      { name: "twitter:image", content: "https://compasseats.com/og-image.jpg" },
    ],
    links: [
